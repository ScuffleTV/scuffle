...
use pb::scuffle::video::v1::RecordingTagRequest;
use ulid::Ulid;
...
pub struct Tag {
	/// The ids of the recordings to tag
	#[clap(long, required = true)]
	id: Ulid,

	/// The tags to add to the recording (JSON)
	#[clap(long, required = true)]
	tags: String,
}
...
impl From<(Ulid, pb::scuffle::video::v1::RecordingTagResponse)> for TagResponse {
	fn from((id, resp): (Ulid, pb::scuffle::video::v1::RecordingTagResponse)) -> Self {
		Self {
			id,
