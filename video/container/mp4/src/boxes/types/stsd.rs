...
use super::{clap::Clap, colr::Colr, pasp::Pasp};
...
impl Stsd {
    ...
    pub fn is_audio(&self) -> bool {
        self.entries
            .iter()
            .any(|e| matches!(e, DynBox::Mp4a(_) | DynBox::Opus(_)))
    }
