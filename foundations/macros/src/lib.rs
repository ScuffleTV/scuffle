...
/// async fn respond(req: Request<Incoming>) -> Result<Response<Body>, Infallible> { todo!() }
///
///
/// async fn respond(req: Request<Incoming>) -> Result<Response<Body>, Infallible> {
///     async fn __inspect_output(req: Request<Incoming>) -> Result<Response<Body>, Infallible> { todo!() }
