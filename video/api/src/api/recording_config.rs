...
impl<G: ApiGlobal> RecordingConfigServiceTrait for RecordingConfigServer<G> {
	async fn get(&self, _request: Request<RecordingConfigGetRequest>) -> Result<Response<RecordingConfigGetResponse>> {
	...
	async fn tag(&self, request: Request<RecordingConfigTagRequest>) -> Result<Response<RecordingConfigTagResponse>> {
	...
	async fn untag(&self, request: Request<RecordingConfigUntagRequest>) -> Result<Response<RecordingConfigUntagResponse>> {
		let global = get_global(&self.global)?;
