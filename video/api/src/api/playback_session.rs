...
use pb::scuffle::video::v1::playback_session_server::{PlaybackSession, PlaybackSessionServer as PlaybackSessionService};
...
impl<G: ApiGlobal> PlaybackSession for PlaybackSessionServer<G> {
	async fn get(&self, _request: Request<PlaybackSessionGetRequest>) -> Result<Response<PlaybackSessionGetResponse>> {
	...
	async fn count(&self, _request: Request<PlaybackSessionCountRequest>) -> Result<Response<PlaybackSessionCountResponse>> {
