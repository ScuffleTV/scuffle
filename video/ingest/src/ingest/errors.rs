...
impl std::fmt::Display for IngestError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
                Self::KeyframeBitrateDistance(a, b) => write!(f, "I01: Keyframe byte distance too large, the bitrate is too high for the keyframe interval: {}KB >= {}KB", a/1024, b/1024),
                Self::BitrateLimit(a, b) => write!(f, "I02: Bitrate limit reached, the bitrate is too high: {}Kbps >= {}Kbps", a/1024, b/1024),
                ...
                Self::KeyframeTimeLimit(a) => write!(f, "I07: Keyframe time distance too large, the keyframe interval is larger than: {}s", a),
                ...
                Self::SubscriptionClosedUnexpectedly => write!(f, "I15: Subscription closed unexpectedly"),
