use pb::scuffle::video::v1::RecordingDeleteRequest;
use ulid::Ulid;
...
impl From<pb::scuffle::video::v1::RecordingDeleteResponse> for DeleteResponse {
	fn from(resp: pb::scuffle::video::v1::RecordingDeleteResponse) -> Self {
		Self {
