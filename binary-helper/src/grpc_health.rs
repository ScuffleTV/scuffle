...
use pb::grpc::health::v1::health_check_response::ServingStatus;
use pb::grpc::health::v1::{health_server, HealthCheckRequest, HealthCheckResponse};
...
> health_server::Health for HealthServer<G, F, H>
{
	...
	async fn check(&self, req: Request<HealthCheckRequest>) -> Result<Response<HealthCheckResponse>> {
		let global = self
			.global
			.upgrade()
