...
pub fn determine_output_renditions(
    ...
    if transcoding_config
        .renditions
        .contains(&Rendition::AudioSource.into())
    {
    ...
    if transcoding_config
        .renditions
        .contains(&Rendition::VideoSource.into())
    {
    ...
    if transcoding_config
        .renditions
        .contains(&Rendition::VideoHd.into())
    {
    ...
    if transcoding_config
        .renditions
        .contains(&Rendition::VideoSd.into())
    {
        resolutions.push(Resolution {
    ...
    if transcoding_config
        .renditions
        .contains(&Rendition::VideoLd.into())
    {
        resolutions.push(Resolution {
