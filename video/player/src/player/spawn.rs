...
use crate::{player::events, tracing_wasm};

use super::{inner::PlayerInnerHolder, runner::Runner};

pub fn spawn_runner(
    runner_tx: mpsc::Sender<()>,
    mut player_rx: mpsc::Receiver<()>,
    ...
    wasm_bindgen_futures::spawn_local(async move {
        ...
        events::dispatch!(runner
            .inner()
            .borrow_mut()
            .events
            .emit(events::UserEvent::Destroyed));
